...
# TODO: implement threading for auxiliary requests
# TODO: check if we are doing the same thing in har.py if data is empty then removing key rather than leaving empty
# TODO: allow for custom filters for request pooling / create request pooling functionality
...
response = None
hook_dict = {}  # will multiple instances make this collide
